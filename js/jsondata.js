function load() {
  ...
  request.onload = function () {
    ...
    $('.pOneTDpd').replaceWith(`${(pOneTwoDay / 2).toFixed(2)}`)
    $('.pOneFDpd').replaceWith(`${(pOneFiveDay / 4).toFixed(2)}`)
    $('.pOneSDpd').replaceWith(`${(pOneSevenDay / 6).toFixed(2)}`)
    $('.pOneAverage').replaceWith(`${(pOneTwoDay / 2).toFixed(2)}`)
    ...
    $('.pTwoTDpd').replaceWith(`${(pTwoTwoDay / 2).toFixed(2)}`)
    $('.pTwoFDpd').replaceWith(`${(pTwoFiveDay / 4).toFixed(2)}`)
    $('.pTwoSDpd').replaceWith(`${(pTwoSevenDay / 6).toFixed(2)}`)
    $('.pTwoAverage').replaceWith(`${(pTwoTwoDay / 2).toFixed(2)}`)
    ...
    $('.pThreeTDpd').replaceWith(`${(pThreeTwoDay / 2).toFixed(2)}`)
    $('.pThreeFDpd').replaceWith(`${(pThreeFiveDay / 4).toFixed(2)}`)
    $('.pThreeSDpd').replaceWith(`${(pThreeSevenDay / 6).toFixed(2)}`)
    $('.pThreeAverage').replaceWith(`${(pThreeTwoDay / 2).toFixed(2)}`)
    ...
    $('.pFourTDpd').replaceWith(`${(pFourTwoDay / 2).toFixed(2)}`)
    $('.pFourFDpd').replaceWith(`${(pFourFiveDay / 4).toFixed(2)}`)
    $('.pFourSDpd').replaceWith(`${(pFourSevenDay / 6).toFixed(2)}`)
    $('.pFourAverage').replaceWith(`${(pFourTwoDay / 2).toFixed(2)}`)
